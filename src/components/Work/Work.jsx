...
export default function Work() {
  return (
    <div className='pt-8 p-5 z-10' id="work"
      ...
      <div className=''>
        ...
        <div className="p-6 flex flex-col justify-start">
          ...
          <h6 classNameName='text-gray-500'>Zevo.ai</h6>
          <p className="text-gray-700 text-base mb-4">
          </p>
          <p className="text-gray-600 text-sm flex items-center"><svg xmlns="http://www.w3.org/2000/svg" className='inline-block m-1' width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
            <path d="M14 0H2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zM1 3.857C1 3.384 1.448 3 2 3h12c.552 0 1 .384 1 .857v10.286c0 .473-.448.857-1 .857H2c-.552 0-1-.384-1-.857V3.857z" />
            <path d="M6.5 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" />
          </svg> August 2023 - Present</p>
        </div>
      </div>
          ...
          <img className=" w-full h-40 lg:h96 md:h-auto object-cover bg-blue-900 lg:object-fit md:w-48 bg-dark rounded-t-lg md:rounded-none md:rounded-l-lg"
            ...
            <div className="p-6 flex flex-col justify-start">
              ...
              <h6 classNameName='text-gray-500'>Cozy Notion</h6>
              <p className="text-gray-700 text-base mb-4">
              </p>
              <p className="text-gray-600 text-sm flex items-center"><svg xmlns="http://www.w3.org/2000/svg" className='inline-block m-1' width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                <path d="M14 0H2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zM1 3.857C1 3.384 1.448 3 2 3h12c.552 0 1 .384 1 .857v10.286c0 .473-.448.857-1 .857H2c-.552 0-1-.384-1-.857V3.857z" />
                <path d="M6.5 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" />
              </svg> April 2023 - July 2023</p>
            </div>
          </div>
