...
function Contact() {
  ...
  function sendEmail(e) {
    ...
    emailjs.sendForm('service_ryaz1xa', 'template_dfbyywu', e.target, 'agExj2rEV82YrE18T')
      .then((result) => {
    ...
    <div className="-mx-4 flex flex-wrap lg:justify-between">
      <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div className="mb-12 max-w-[570px] lg:mb-0">
          <h2 className="animate__fadeInUp animate__animated font-sans text-3xl font-bold lg:text-start text-center text-violet-800 sm:text-4xl sm:leading-none z-10">
          Contact
           </h2>       
          <h2
            className="text-dark mb-6 text-[32px] lg:text-start text-center font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
          >
         LETS GET IN TOUCH
          </h2>
          ...
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              <h4 className="text-dark mb-1 text-xl font-bold">Address</h4>
...
Panvel, Navi Mumbai, MH India              </p>
          ...
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              ...
              <p className="text-body-color text-base">mayurshrikantjadhav@outlook.com</p>
            </div>
          </div>
        </div>
      </div>
