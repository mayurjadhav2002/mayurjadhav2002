...
const SharePost = ({currentUrl}) => {
  ...
  const twitterUrl = `https://twitter.com/share?url=${encodeURIComponent(currentUrl)}`;
  ...
  return (
    <>
      ...
      <Link
        ...
        className="ml-3 mb-3 inline-flex h-9 w-9 items-center justify-center rounded-md bg-primary bg-opacity-10 text-body-color duration-300 hover:bg-opacity-100 hover:text-white         dark:bg-primary
        "
      >
        <svg
          width="18"
